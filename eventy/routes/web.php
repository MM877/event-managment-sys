...
Route::get('/my-events', [EventController::class, 'myEvents'])->middleware('auth')->name('events.index');
...
// Attendance routes
Route::resource('attending', AttendingController::class);
...
Route::resource('saved-events', SavedEventController::class);
