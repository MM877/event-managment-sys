...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('saved-events.index')" :active="request()->routeIs('saved-events.*')" wire:navigate>
                        {{ __('Saved Events') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
            <x-responsive-nav-link :href="route('my-events.index')" :active="request()->routeIs('my-events.index')" wire:navigate>
                {{ __('My Events') }}
            </x-responsive-nav-link>
            @endauth
            ...
            <x-responsive-nav-link :href="route('events.attendance')" :active="request()->routeIs('saved-events.*')" wire:navigate>
                {{ __('Saved Events') }}
            </x-responsive-nav-link>
        </div>
