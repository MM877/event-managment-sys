        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium mb-4">{{ __('Events You Created') }}</h3>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-4 flex justify-between items-center">
                                            ...
                                            <div class="flex space-x-2">
                                                <a href="{{ route('events.edit', $event) }}" class="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100">
                    ...
                    @else
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
                            ...
                            <p class="mt-4 text-lg">{{ __("You haven't created any events yet.") }}</p>
